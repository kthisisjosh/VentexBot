	...
	reactionButtons: [
		{
			emoji: "♻️",
			type: "Another one",
			response: () => screenshots.url[Math.round(Math.random() * screenshots.url.length - 2)],
		},
	],
...
bot.on("messageCreate", (msg) => {
	if (msg.content === "!fml") {
		if (dayjs(dayjs()).isBetween("2021-09-08", dayjs("2021-12-07"))) {
			bot.createMessage(
				msg.channel.id,
				`Hang in there! You've got ${dayjs().to(dayjs("2021-12-07:00:00-05:00"), true)} until this is all over and about ${dayjs().to(
					dayjs("2021-12-09T00:00:00-05:00"),
					true
				)} until the start of exams. <:neckrope:762813873614749747> <:PepeHands:713964579209871401> <:Kaizer:230460817227644938> <:Jerome:704531259971338271> <:deadchromosome:367460111800860692> <:SeemsGood:321103114486677504> <:danielhoe:575898686224334868> <:ugly:458085989169233921> <:sendhelp:575899004924198942> `
			);
		} else if (dayjs(dayjs()).isBetween("2021-12-09", dayjs("2021-12-23"))) {
			bot.createMessage(
				msg.channel.id,
				`Hang in there! You've got ${dayjs().to(
					dayjs("2021-12-23T00:00:00-05:00"),
					true
				)} until exams are over. <:neckrope:762813873614749747> <:PepeHands:713964579209871401> <:Kaizer:230460817227644938> <:Jerome:704531259971338271> <:deadchromosome:367460111800860692> <:SeemsGood:321103114486677504> <:danielhoe:575898686224334868> <:ugly:458085989169233921> <:sendhelp:575899004924198942> `
			);
		} else if (dayjs(dayjs()).isBetween("2022-01-05", dayjs("2022-04-02"))) {
			bot.createMessage(
				msg.channel.id,
				`Hang in there! You've got ${dayjs().to(dayjs("2022-04-02:00:00-05:00"), true)} until this is all over and about ${dayjs().to(
					dayjs("2022-04-08T00:00:00-05:00"),
					true
				)} until the start of exams. <:neckrope:762813873614749747> <:PepeHands:713964579209871401> <:Kaizer:230460817227644938> <:Jerome:704531259971338271> <:deadchromosome:367460111800860692> <:SeemsGood:321103114486677504> <:danielhoe:575898686224334868> <:ugly:458085989169233921> <:sendhelp:575899004924198942> `
			);
		} else if (dayjs(dayjs()).isBetween("2022-04-08", dayjs("2022-04-26"))) {
			bot.createMessage(
				msg.channel.id,
				`Hang in there! You've got ${dayjs().to(
					dayjs("2022-04-26T00:00:00-05:00"),
					true
				)} until exams are over. <:neckrope:762813873614749747> <:PepeHands:713964579209871401> <:Kaizer:230460817227644938> <:Jerome:704531259971338271> <:deadchromosome:367460111800860692> <:SeemsGood:321103114486677504> <:danielhoe:575898686224334868> <:ugly:458085989169233921> <:sendhelp:575899004924198942> `
			);
		} else {
			bot.createMessage(
				msg.channel.id,
				`Congratulations! You've finished the school year! <:Pog:478592701915332609> <:marcusgasm:575898575410561024> <:EZ:713964592962994268> <:5Head:737008087847796858> <a:Clap:713964562910674994>`
			);
		}
	}
});
